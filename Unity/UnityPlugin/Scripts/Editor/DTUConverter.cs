...
namespace Daz3D
{
    ...
    public struct DTU
    {
        ...
        public string DTUDir
        {
            get
            {
                ...
                {
                    _DTUDir = new FileInfo(DTUPath).Directory.FullName;
        ...
        public void ToggleCommonMaterialProperties(ref Material mat, string matNameLower, bool isTransparent = false,
        ...
        /// <returns></returns>
        public Texture2D ImportTextureFromPath(string path, string localAssetDir,
    ...
    public struct DTUMaterialProperty
    {
        ...
        public Color Color
        {
            get { return Value.AsColor; }
        }

        public float ColorStrength
        {
            get { return Utilities.GetStrengthFromColor(Color); }
        }

        public float Float
        {
            get { return (float) Value.AsDouble; }
        }

        public bool Boolean
        {
            get { return Value.AsDouble > 0.5; }
        }
    }
