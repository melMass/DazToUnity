...
QSize DzUnitySubdivisionDialog::minimumSizeHint() const
{
	return QSize(800, 800);
}


void DzUnitySubdivisionDialog::PrepareDialog()
{
...
void DzUnitySubdivisionDialog::CreateList(DzNode* Node)
{
...
void DzUnitySubdivisionDialog::HandleSubdivisionLevelChanged(const QString& text)
{
...
DzNode* DzUnitySubdivisionDialog::FindObject(DzNode* Node, QString Name)
{
	DzObject* Object = Node->getObject();
	if (Object)
	{
...
void DzUnitySubdivisionDialog::LockSubdivisionProperties(bool subdivisionEnabled)
{
	DzNode* Selection = dzScene->getPrimarySelection();
	foreach(QComboBox* combo, SubdivisionCombos)
	{
