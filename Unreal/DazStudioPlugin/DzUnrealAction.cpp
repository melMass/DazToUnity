...
void DzUnrealAction::WriteConfiguration()
{
	 ...
	 SUCCESS(QString("Wrote DTU File %1").arg(DTUfile.fileName()))

	 WARN(QString("Sending DTU path to Unreal at %1/%2").arg("127.0.0.1").arg(Port))
...
QString DzUnrealAction::appendPath(const QString &path1, const QString &path2)
{
